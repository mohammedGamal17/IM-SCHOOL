...
<div class="col-md-10">
<a href="mailto:chiraggoel.islamgad999@gmail.com" style="color:#000000">islamgad999@gmail.com</a><br /><br />
...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <div class="row">
		<div class="col-md-4">
		 <img src="image/Screenshot (71).png" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/profile.php?id=100004612066055" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Gimy</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+201009363679</h4>
		<h4 style="font-family:'typo' ">gimy@gmail.com</h4>
		<h4 style="font-family:'typo' ">Software Engineer</h4></div></div>
		</p>
      </div>
